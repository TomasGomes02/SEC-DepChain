...
public class ByzantineRandomMessageTest {
    ...
    public void setup() throws Exception {
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            ByzantineBehaviour behaviour = (i == 1) ? ByzantineBehaviour.RANDOM_MESSAGE : ByzantineBehaviour.NONE;
    ...
    @Test
    public void testCrashedLeaderTriggersViewChange() {
        ...
        try {
            ...
            // wait for honest nodes to timeout
            Logger.test(null, "Waiting 35 seconds for consensus...");
            Thread.sleep(35000); 
            ...
            assertEquals(expectedReceiverBalance, finalClient11DEP, "BFT FAILURE: The honest nodes failed to reach consensus after the Leader crashed");
            assertTrue(finalClient10DEP < initialClient10DEP, "Sender wasn't charged");
            
            Logger.test(null, "Honest replicas successfully bypassed the CRASH leader");
